...
//Task1  Creating a new array with name, position and salary properties
const newArr = parsed.map(obj => ({ name: obj.name, position: obj.hr.position, salary: obj.hr.salary }));
...
const earliestEmployee = parsed.sort((b, a) => (new Date(b.hr.start_date) - new Date(a.hr.start_date)))[0].name;
